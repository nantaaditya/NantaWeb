...
<script src="/js/administrator/gallery/controllers.js"></script>
<script src="/js/administrator/gallery/app.js"></script>
</head>
						...
						<div class="input-group">
							...
							<span class="input-group-btn">
								<button type="button" class="btn btn-success btn-flat"
									data-toggle="modal" data-target="#add-picture">
					...
					<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
						...
						<div class="table-responsive">
							<table class="table table-hover table-striped table-condensed">
								...
								<tbody>
									<tr
										dir-paginate="p in pictures | filter:searchKeyword | itemsPerPage: '5'">
										<td>{{$index+1}}</td>
										<td>{{p.title}}</td>
										<td><img src="{{p.image}}" alt="{{p.name}}"
											class="img-responsive" /></td>
										<td><span> <label class="label label-success"
												style="cursor: pointer" ng-show="p.status==true"
												ng-click="togglePicture(p.id, !p.status)">Active</label> <label
												class="label label-danger" style="cursor: pointer"
												ng-show="p.status==false"
												ng-click="togglePicture(p.id, !p.status)">Disable</label>
										</span></td>
										<td>
											<div class="btn-group">
												<button class="btn btn-danger"
													ng-click="deletePicture(p.id)">
						...
						<!--MODAL-->
						<div id="add-picture" class="modal fade" role="dialog">
							<div class="modal-dialog modal-sm">
								<div class="modal-content">
									<div class="modal-header">
										<button type="button" class="close" data-dismiss="modal">&times;</button>
										...
										<form>
											<div class="form-group">
												<label class="label label-default">Title</label> <input
													type="text" class="form-control" ng-model="picture.title" />
											</div>
											<div class="form-group">
											...
											<div class="btn-group pull-right">
												<button type="button" class="btn btn-default"
													ng-click="addPicture('false')">
													<i class="fa fa-save"></i> Save
												</button>
												<button type="button" class="btn btn-success"
													ng-click="addPicture('true')">
